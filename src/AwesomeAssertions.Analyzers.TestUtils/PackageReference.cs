...
public sealed class PackageReference
{
    ...
    internal static PackageReference NETStandard2_0 { get; } = new("NETStandard.Library", "2.0.3", "build/netstandard2.0/ref/");
    internal static PackageReference NETStandard2_1 { get; } = new("NETStandard.Library.Ref", "2.1.0", "ref/netstandard2.1/ref/");
    internal static PackageReference DotNet6 { get; } = new("Microsoft.NETCore.App.Ref", "6.0.31", "ref/net6.0/");
    internal static PackageReference DotNet7 { get; } = new("Microsoft.NETCore.App.Ref", "7.0.20", "ref/net7.0/");
    internal static PackageReference DotNet8 { get; } = new("Microsoft.NETCore.App.Ref", "8.0.6", "ref/net8.0/");
